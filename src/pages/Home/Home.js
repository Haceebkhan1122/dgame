...
const Home = () => {
  ...
  return (
    <>
          ...
          <Row>
            <Col md={24}>
              <div className="center_content">
                <h4 className="sub_heading">JOIN TOURNAMENTS</h4>
                <h1 className="primary_heading w-auto">Upcoming Tournaments</h1>
              </div>
            </Col>
          </Row>
          <Row className="join_tournament_card_row">
            <Col md={3}>
              <Card className="bg_card_image">
                <Card.Body>
          ...
          <Row>
            ...
            <Col md={6}>
              <div className="d-flex">
                ...
                <div className="join_char_controller mt-5 pt-4">
            ...
            <Col md={6}>
              <div className="d-flex">
                <div className="join_char_controller mt-5 pt-4 e2">
      ...
      <section className="ten-characters-scrollable">
        <Container>
          <Row>
            <Col md={6}>
